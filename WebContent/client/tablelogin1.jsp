...
<div  class="para-bg" data-enllax-ratio=".5" data-enllax-direction="vertical" style="background:url(img/banner1.jpg) no-repeat;"></div>
    <div class="container">
         <div class="section-heading text-center">
             <h1 class="section-title-big"><span class="colored">Reservation</span></h1>
            <div class="divider">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
               <div class="col-md-12"><h2 class="title-md text-center mb-35">Reserve a Table Online!</h2></div>
                <div class="contact-form-wrap">
                    <form class="reservation-form img-icon-input" action="<%=request.getContextPath() %>/login">
                        <div class="col-md-6">
                            <div class="input-group ">
                                <input type="text"  class="form-control" name="tbl" placeholder="table number">
                            </div><!-- /input-group -->
                        </div>
                        <div class="col-md-6">
                            <div class="input-group ">
                             ...
                             <div class="text-center">
                                <button type="submit" class="btn-primary btn-submit">Generate OTP</button>
        ...
        <div class="row">
            <div class="col-sm-12 col-sm-offset-1 text-center" >
                <div class="call-numbers text-center slash clearfix">
                    <div>
                        <span class="number">+91 9428 90 61 69   </span>
                        <span class="text">Call For Catering Service</span>
                    </div>
                </div><!--call-number-->
            </div>
        </div>
