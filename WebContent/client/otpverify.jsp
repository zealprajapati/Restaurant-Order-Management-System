			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						<div class="col-md-12">
							<h2 class="title-md text-center mb-35">WELCOME!!!</h2>
						</div>
						<div class="contact-form-wrap">
							<form class="reservation-form img-icon-input"
								action="<%=request.getContextPath()%>/otpverification">
								<div class="col-md-6">
									<div class="input-group ">
								...
								<div class="col-md-6">
									<div class="input-group ">
										<input type="submit" class="form-control" style="color: teal"
											value="Verify">
									</div>
								</div>
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="call-numbers text-center slash clearfix">
							<div>
								<span class="number">+1-202-555-0128 </span> <span class="text">Call
									For Table Reservation</span>
							</div>
							<div>
								<span class="number">+1-202-555-0128 </span> <span class="text">Call
									For Table Reservation</span>
